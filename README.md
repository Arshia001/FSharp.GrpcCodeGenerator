...
* A library of pre-compiled built-in types from the `google.protobuf` namespace
...
you need to stop passing DTO's into your business logic.
...
which is a perfect match for CLR enums, including the possibility of encountering numbers with no assigned value.
