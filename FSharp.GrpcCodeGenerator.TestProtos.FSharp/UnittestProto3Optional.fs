...
type TestProto3Optional = {
    ...
    member me.HasOptionalNestedEnum =
        me.OptionalNestedEnum <> ValueNone
    [<global.System.Diagnostics.DebuggerNonUserCodeAttribute>]
