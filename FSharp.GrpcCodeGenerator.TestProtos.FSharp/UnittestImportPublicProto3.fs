...
module UnittestImportPublicProto3Reflection =
    ...
    let private descriptorBackingField: global.System.Lazy<global.Google.Protobuf.Reflection.FileDescriptor> =
        let descriptorData = global.System.Convert.FromBase64String("\
            ...
            b3J0IiMKE1B1YmxpY0ltcG9ydE1lc3NhZ2USDAoBZRgBIAEoBVIBZUImqgIjRlNoYXJwLkdycGNDb2Rl\
            R2VuZXJhdG9yLlRlc3RQcm90b3NiBnByb3RvMw==")
            ...
            (fun () ->
                global.Google.Protobuf.Reflection.FileDescriptor.FromGeneratedCode(
                    ...
                    new global.Google.Protobuf.Reflection.GeneratedClrTypeInfo(
                        ...
                        null,
                        [|
                            new global.Google.Protobuf.Reflection.GeneratedClrTypeInfo(typeof<global.FSharp.GrpcCodeGenerator.TestProtos.PublicImportMessage>, global.FSharp.GrpcCodeGenerator.TestProtos.PublicImportMessage.Parser, [| "E" |], null, null, null, null)
                        |]
                    )
                )
            ),
...
type PublicImportMessage = {
    ...
    interface global.Google.Protobuf.IMessage with
        ...
        [<global.System.Diagnostics.DebuggerNonUserCodeAttribute>]
        member __.Descriptor = global.FSharp.GrpcCodeGenerator.TestProtos.UnittestImportPublicProto3Reflection.PublicImportMessage_Descriptor()
